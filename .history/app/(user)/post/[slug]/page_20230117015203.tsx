    ...
    return (
        <article className="px-12 pb-28">
            <section className="space-y-2 border border-slate-500 text-white">
                ...
                <div className="justify-self-center w-4/5 ml-5 font-light first-letter:font-serif first-letter:text-3xl first-letter:text-sky-700 first-letter:font-semibold" >
