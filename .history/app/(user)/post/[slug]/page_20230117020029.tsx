...
async function Post({params: { slug }}: Props) {
    ...
    *[_type=='post' && slug.current == $slug][0]
    ...
    return (
        <article className="px-12 pb-28 max-w-5xl ml-auto">
            <section className="space-y-2 border border-slate-500 text-white">
                ...
                <div className="w-4/5 max-w-3xl ml-auto mt-5 font-light first-letter:font-serif first-letter:text-3xl first-letter:text-sky-700 first-letter:font-semibold" >
