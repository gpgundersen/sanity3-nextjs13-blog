    ...
    return (
        <article className="px-10 pb-28">
            <section className="space-y-2 border border-slate-500 text-white">
                ...
                <div className="w-10/12 object-center block font-light first-letter:font-serif first-letter:text-3xl first-letter:text-sky-700 first-letter:font-semibold" >
