                ...
                {posts.map((post) => (
                    <div key={post._id} className="flex flex-col group cursor-pointer"> 
                        ...
                        <div className="absolute bottom-0 w-full bg-opacity-20 bg-slate-800 backdrop-blur-lg 
                         text-white-50 p-2 flex justify-between">
                            <div>
                            ...
                            <div>
                                {post.categories.map((category) => (
                                    <div className="bg-emerald-200 bg-opacity-75 text-center text-sm font-semibold text-emerald-900 rounded-lg m-1 p-1">
                                        <p>{category.title}</p>
                                    </div>
                                ))}
                            </div>
