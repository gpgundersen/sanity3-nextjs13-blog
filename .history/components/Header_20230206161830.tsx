...
function Header() {
    return (
        <header className="flex items-center justify-end space-x-1 font-bold px-7 py-4 bg-orange-50">
            <div className="flex items-center justify-end space-x-4 mx-4 text-blue-900 drop-shadow-sm">
                ...
                <div className="hover:text-blue-500"><Link href="/aiart/">Ai Artwork</Link></div>
            </div>
