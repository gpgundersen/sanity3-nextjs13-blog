...
function Footer() {
    return <div className="bg-slate-800 text-slate-200">
        <div className="flex items-center justify-between space-x-5 space-y-2 p-1">
          ...
          <div className="flex justify-center mt-1 p-2 bg-gradient-to-b from-slate-800 to-slate-900">
            <p className="text-white m-1 font-light">Visit our</p><FbIcon />
        </div>
       <span className="font-serif text-slate-600 text-center bg-black mt-1">© wisenexus.net, 2023</span>
       </div>
}
