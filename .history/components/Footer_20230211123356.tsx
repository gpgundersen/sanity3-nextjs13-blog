...
function Footer() {
    return <div className="bg-slate-800 text-slate-200">
        <div className="flex items-center justify-between space-x-5 space-y-2 p-1">
          <ul className="font-light text-xl m-1 p-1">
          <li><Link href="/" className="hover:bg-zinc-600">Home</Link></li>
          <li><Link href="/about/wise-phil" className="hover:bg-zinc-600">About</Link></li>
          </ul>
          <ul className="">
