                         ...
                         text-slate-50 p-2 flex justify-between">
                            ...
                            <div className="flex flex-col md:flex-row">
                                {post.categories.map((category) => (
                                    <div className="bg-amber-100 bg-opacity-90 text-center text-sm font-semibold text-amber-900 rounded-lg outline-amber-600 drop-shadow-md shadow-red-500 p-1 m-2">
                                        <p>{category.title}</p>
                                    </div>
                                ))}
                            </div>
